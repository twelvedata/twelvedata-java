 ...
 */
@JsonPropertyOrder({
  GetIncomeStatement200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetIncomeStatement200ResponseMeta.JSON_PROPERTY_NAME,
  GetIncomeStatement200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetIncomeStatement200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetIncomeStatement200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetIncomeStatement200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  GetIncomeStatement200ResponseMeta.JSON_PROPERTY_PERIOD
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetIncomeStatement200ResponseMeta {
  ...
  public GetIncomeStatement200ResponseMeta() { 
  }

  public GetIncomeStatement200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetIncomeStatement200ResponseMeta name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetIncomeStatement200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetIncomeStatement200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetIncomeStatement200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetIncomeStatement200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public GetIncomeStatement200ResponseMeta period(@javax.annotation.Nonnull String period) {
    this.period = period;
    return this;
  }
  ...
  /**
   * Return true if this GetIncomeStatement_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetIncomeStatement200ResponseMeta getIncomeStatement200ResponseMeta = (GetIncomeStatement200ResponseMeta) o;
    return Objects.equals(this.symbol, getIncomeStatement200ResponseMeta.symbol) &&
        Objects.equals(this.name, getIncomeStatement200ResponseMeta.name) &&
        Objects.equals(this.currency, getIncomeStatement200ResponseMeta.currency) &&
        Objects.equals(this.exchange, getIncomeStatement200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getIncomeStatement200ResponseMeta.micCode) &&
        Objects.equals(this.exchangeTimezone, getIncomeStatement200ResponseMeta.exchangeTimezone) &&
        Objects.equals(this.period, getIncomeStatement200ResponseMeta.period);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIncomeStatement200ResponseMeta {\n");
