 ...
 */
@JsonPropertyOrder({
  GetTimeSeriesPpo200ResponseMetaIndicator.JSON_PROPERTY_NAME,
  GetTimeSeriesPpo200ResponseMetaIndicator.JSON_PROPERTY_SERIES_TYPE,
  GetTimeSeriesPpo200ResponseMetaIndicator.JSON_PROPERTY_FAST_PERIOD,
  GetTimeSeriesPpo200ResponseMetaIndicator.JSON_PROPERTY_SLOW_PERIOD,
  GetTimeSeriesPpo200ResponseMetaIndicator.JSON_PROPERTY_MA_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetTimeSeriesPpo200ResponseMetaIndicator {
  ...
  public GetTimeSeriesPpo200ResponseMetaIndicator() { 
  }

  public GetTimeSeriesPpo200ResponseMetaIndicator name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetTimeSeriesPpo200ResponseMetaIndicator seriesType(@javax.annotation.Nonnull String seriesType) {
  ...
  public GetTimeSeriesPpo200ResponseMetaIndicator fastPeriod(@javax.annotation.Nonnull Long fastPeriod) {
  ...
  public GetTimeSeriesPpo200ResponseMetaIndicator slowPeriod(@javax.annotation.Nonnull Long slowPeriod) {
  ...
  public GetTimeSeriesPpo200ResponseMetaIndicator maType(@javax.annotation.Nonnull String maType) {
    this.maType = maType;
    return this;
  }
  ...
  /**
   * Return true if this GetTimeSeriesPpo_200_response_meta_indicator object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetTimeSeriesPpo200ResponseMetaIndicator getTimeSeriesPpo200ResponseMetaIndicator = (GetTimeSeriesPpo200ResponseMetaIndicator) o;
    return Objects.equals(this.name, getTimeSeriesPpo200ResponseMetaIndicator.name) &&
        Objects.equals(this.seriesType, getTimeSeriesPpo200ResponseMetaIndicator.seriesType) &&
        Objects.equals(this.fastPeriod, getTimeSeriesPpo200ResponseMetaIndicator.fastPeriod) &&
        Objects.equals(this.slowPeriod, getTimeSeriesPpo200ResponseMetaIndicator.slowPeriod) &&
        Objects.equals(this.maType, getTimeSeriesPpo200ResponseMetaIndicator.maType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTimeSeriesPpo200ResponseMetaIndicator {\n");
