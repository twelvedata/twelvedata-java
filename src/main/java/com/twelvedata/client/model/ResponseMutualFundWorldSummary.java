 ...
 */
@JsonPropertyOrder({
  ResponseMutualFundWorldSummary.JSON_PROPERTY_SYMBOL,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_NAME,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_FUND_FAMILY,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_FUND_TYPE,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_CURRENCY,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_SHARE_CLASS_INCEPTION_DATE,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_YTD_RETURN,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_EXPENSE_RATIO_NET,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_YIELD,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_NAV,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_MIN_INVESTMENT,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_TURNOVER_RATE,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_NET_ASSETS,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_OVERVIEW,
  ResponseMutualFundWorldSummary.JSON_PROPERTY_PEOPLE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class ResponseMutualFundWorldSummary {
  ...
  public ResponseMutualFundWorldSummary() { 
  }

  public ResponseMutualFundWorldSummary symbol(@javax.annotation.Nullable String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public ResponseMutualFundWorldSummary name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ResponseMutualFundWorldSummary fundFamily(@javax.annotation.Nullable String fundFamily) {
  ...
  public ResponseMutualFundWorldSummary fundType(@javax.annotation.Nullable String fundType) {
  ...
  public ResponseMutualFundWorldSummary currency(@javax.annotation.Nullable String currency) {
  ...
  public ResponseMutualFundWorldSummary shareClassInceptionDate(@javax.annotation.Nullable String shareClassInceptionDate) {
  ...
  public ResponseMutualFundWorldSummary ytdReturn(@javax.annotation.Nullable Double ytdReturn) {
  ...
  public ResponseMutualFundWorldSummary expenseRatioNet(@javax.annotation.Nullable Double expenseRatioNet) {
  ...
  public ResponseMutualFundWorldSummary yield(@javax.annotation.Nullable Double yield) {
    this.yield = yield;
    return this;
  }
  ...
  public ResponseMutualFundWorldSummary nav(@javax.annotation.Nullable Double nav) {
    this.nav = nav;
    return this;
  }
  ...
  public ResponseMutualFundWorldSummary minInvestment(@javax.annotation.Nullable Long minInvestment) {
  ...
  public ResponseMutualFundWorldSummary turnoverRate(@javax.annotation.Nullable Double turnoverRate) {
  ...
  public ResponseMutualFundWorldSummary netAssets(@javax.annotation.Nullable Long netAssets) {
  ...
  public ResponseMutualFundWorldSummary overview(@javax.annotation.Nullable String overview) {
  ...
  public ResponseMutualFundWorldSummary people(@javax.annotation.Nullable List<GetMutualFundsWorld200ResponseMutualFundSummaryPeopleInner> people) {
    this.people = people;
    return this;
  }

  public ResponseMutualFundWorldSummary addPeopleItem(GetMutualFundsWorld200ResponseMutualFundSummaryPeopleInner peopleItem) {
    if (this.people == null) {
  ...
  /**
   * Return true if this ResponseMutualFundWorldSummary object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ResponseMutualFundWorldSummary responseMutualFundWorldSummary = (ResponseMutualFundWorldSummary) o;
    return Objects.equals(this.symbol, responseMutualFundWorldSummary.symbol) &&
        Objects.equals(this.name, responseMutualFundWorldSummary.name) &&
        Objects.equals(this.fundFamily, responseMutualFundWorldSummary.fundFamily) &&
        Objects.equals(this.fundType, responseMutualFundWorldSummary.fundType) &&
        Objects.equals(this.currency, responseMutualFundWorldSummary.currency) &&
        Objects.equals(this.shareClassInceptionDate, responseMutualFundWorldSummary.shareClassInceptionDate) &&
        Objects.equals(this.ytdReturn, responseMutualFundWorldSummary.ytdReturn) &&
        Objects.equals(this.expenseRatioNet, responseMutualFundWorldSummary.expenseRatioNet) &&
        Objects.equals(this.yield, responseMutualFundWorldSummary.yield) &&
        Objects.equals(this.nav, responseMutualFundWorldSummary.nav) &&
        Objects.equals(this.minInvestment, responseMutualFundWorldSummary.minInvestment) &&
        Objects.equals(this.turnoverRate, responseMutualFundWorldSummary.turnoverRate) &&
        Objects.equals(this.netAssets, responseMutualFundWorldSummary.netAssets) &&
        Objects.equals(this.overview, responseMutualFundWorldSummary.overview) &&
        Objects.equals(this.people, responseMutualFundWorldSummary.people);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseMutualFundWorldSummary {\n");
