 ...
 */
@JsonPropertyOrder({
  GetTimeSeriesBBands200ResponseMetaIndicator.JSON_PROPERTY_NAME,
  GetTimeSeriesBBands200ResponseMetaIndicator.JSON_PROPERTY_SERIES_TYPE,
  GetTimeSeriesBBands200ResponseMetaIndicator.JSON_PROPERTY_TIME_PERIOD,
  GetTimeSeriesBBands200ResponseMetaIndicator.JSON_PROPERTY_SD,
  GetTimeSeriesBBands200ResponseMetaIndicator.JSON_PROPERTY_MA_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetTimeSeriesBBands200ResponseMetaIndicator {
  ...
  public GetTimeSeriesBBands200ResponseMetaIndicator() { 
  }

  public GetTimeSeriesBBands200ResponseMetaIndicator name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetTimeSeriesBBands200ResponseMetaIndicator seriesType(@javax.annotation.Nonnull String seriesType) {
  ...
  public GetTimeSeriesBBands200ResponseMetaIndicator timePeriod(@javax.annotation.Nonnull Long timePeriod) {
  ...
  public GetTimeSeriesBBands200ResponseMetaIndicator sd(@javax.annotation.Nonnull Double sd) {
    this.sd = sd;
    return this;
  }
  ...
  public GetTimeSeriesBBands200ResponseMetaIndicator maType(@javax.annotation.Nonnull String maType) {
    this.maType = maType;
    return this;
  }
  ...
  /**
   * Return true if this GetTimeSeriesBBands_200_response_meta_indicator object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetTimeSeriesBBands200ResponseMetaIndicator getTimeSeriesBBands200ResponseMetaIndicator = (GetTimeSeriesBBands200ResponseMetaIndicator) o;
    return Objects.equals(this.name, getTimeSeriesBBands200ResponseMetaIndicator.name) &&
        Objects.equals(this.seriesType, getTimeSeriesBBands200ResponseMetaIndicator.seriesType) &&
        Objects.equals(this.timePeriod, getTimeSeriesBBands200ResponseMetaIndicator.timePeriod) &&
        Objects.equals(this.sd, getTimeSeriesBBands200ResponseMetaIndicator.sd) &&
        Objects.equals(this.maType, getTimeSeriesBBands200ResponseMetaIndicator.maType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTimeSeriesBBands200ResponseMetaIndicator {\n");
