 ...
 */
@JsonPropertyOrder({
  ResponseMutualFundWorldPerformance.JSON_PROPERTY_TRAILING_RETURNS,
  ResponseMutualFundWorldPerformance.JSON_PROPERTY_ANNUAL_TOTAL_RETURNS,
  ResponseMutualFundWorldPerformance.JSON_PROPERTY_QUARTERLY_TOTAL_RETURNS,
  ResponseMutualFundWorldPerformance.JSON_PROPERTY_LOAD_ADJUSTED_RETURN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class ResponseMutualFundWorldPerformance {
  ...
  public ResponseMutualFundWorldPerformance() { 
  }

  public ResponseMutualFundWorldPerformance trailingReturns(@javax.annotation.Nullable List<GetMutualFundsWorld200ResponseMutualFundPerformanceTrailingReturnsInner> trailingReturns) {
    this.trailingReturns = trailingReturns;
    return this;
  }

  public ResponseMutualFundWorldPerformance addTrailingReturnsItem(GetMutualFundsWorld200ResponseMutualFundPerformanceTrailingReturnsInner trailingReturnsItem) {
  ...
  public ResponseMutualFundWorldPerformance annualTotalReturns(@javax.annotation.Nullable List<GetMutualFundsWorld200ResponseMutualFundPerformanceAnnualTotalReturnsInner> annualTotalReturns) {
    this.annualTotalReturns = annualTotalReturns;
    return this;
  }

  public ResponseMutualFundWorldPerformance addAnnualTotalReturnsItem(GetMutualFundsWorld200ResponseMutualFundPerformanceAnnualTotalReturnsInner annualTotalReturnsItem) {
  ...
  public ResponseMutualFundWorldPerformance quarterlyTotalReturns(@javax.annotation.Nullable List<GetMutualFundsWorld200ResponseMutualFundPerformanceQuarterlyTotalReturnsInner> quarterlyTotalReturns) {
    this.quarterlyTotalReturns = quarterlyTotalReturns;
    return this;
  }

  public ResponseMutualFundWorldPerformance addQuarterlyTotalReturnsItem(GetMutualFundsWorld200ResponseMutualFundPerformanceQuarterlyTotalReturnsInner quarterlyTotalReturnsItem) {
  ...
  public ResponseMutualFundWorldPerformance loadAdjustedReturn(@javax.annotation.Nullable List<GetMutualFundsWorld200ResponseMutualFundPerformanceLoadAdjustedReturnInner> loadAdjustedReturn) {
    this.loadAdjustedReturn = loadAdjustedReturn;
    return this;
  }

  public ResponseMutualFundWorldPerformance addLoadAdjustedReturnItem(GetMutualFundsWorld200ResponseMutualFundPerformanceLoadAdjustedReturnInner loadAdjustedReturnItem) {
  ...
  /**
   * Return true if this ResponseMutualFundWorldPerformance object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ResponseMutualFundWorldPerformance responseMutualFundWorldPerformance = (ResponseMutualFundWorldPerformance) o;
    return Objects.equals(this.trailingReturns, responseMutualFundWorldPerformance.trailingReturns) &&
        Objects.equals(this.annualTotalReturns, responseMutualFundWorldPerformance.annualTotalReturns) &&
        Objects.equals(this.quarterlyTotalReturns, responseMutualFundWorldPerformance.quarterlyTotalReturns) &&
        Objects.equals(this.loadAdjustedReturn, responseMutualFundWorldPerformance.loadAdjustedReturn);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseMutualFundWorldPerformance {\n");
