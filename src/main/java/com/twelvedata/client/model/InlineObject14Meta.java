...
import com.twelvedata.client.model.InlineObject14MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject14Meta.JSON_PROPERTY_SYMBOL,
  InlineObject14Meta.JSON_PROPERTY_INTERVAL,
  InlineObject14Meta.JSON_PROPERTY_CURRENCY,
  InlineObject14Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject14Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject14Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject14Meta.JSON_PROPERTY_TYPE,
  InlineObject14Meta.JSON_PROPERTY_INDICATOR
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class InlineObject14Meta {
  ...
  @javax.annotation.Nonnull
  private InlineObject14MetaIndicator indicator;

  public InlineObject14Meta() { 
  }

  public InlineObject14Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject14Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject14Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject14Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject14Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject14Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject14Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject14Meta indicator(@javax.annotation.Nonnull InlineObject14MetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InlineObject14MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull InlineObject14MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_14_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineObject14Meta inlineObject14Meta = (InlineObject14Meta) o;
    return Objects.equals(this.symbol, inlineObject14Meta.symbol) &&
        Objects.equals(this.interval, inlineObject14Meta.interval) &&
        Objects.equals(this.currency, inlineObject14Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject14Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject14Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject14Meta.micCode) &&
        Objects.equals(this.type, inlineObject14Meta.type) &&
        Objects.equals(this.indicator, inlineObject14Meta.indicator);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineObject14Meta {\n");
