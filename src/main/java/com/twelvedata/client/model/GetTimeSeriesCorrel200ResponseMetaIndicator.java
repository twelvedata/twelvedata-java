 ...
 */
@JsonPropertyOrder({
  GetTimeSeriesCorrel200ResponseMetaIndicator.JSON_PROPERTY_NAME,
  GetTimeSeriesCorrel200ResponseMetaIndicator.JSON_PROPERTY_SERIES_TYPE1,
  GetTimeSeriesCorrel200ResponseMetaIndicator.JSON_PROPERTY_SERIES_TYPE2,
  GetTimeSeriesCorrel200ResponseMetaIndicator.JSON_PROPERTY_TIME_PERIOD
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetTimeSeriesCorrel200ResponseMetaIndicator {
  ...
  public GetTimeSeriesCorrel200ResponseMetaIndicator() { 
  }

  public GetTimeSeriesCorrel200ResponseMetaIndicator name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetTimeSeriesCorrel200ResponseMetaIndicator seriesType1(@javax.annotation.Nonnull String seriesType1) {
  ...
  public GetTimeSeriesCorrel200ResponseMetaIndicator seriesType2(@javax.annotation.Nonnull String seriesType2) {
  ...
  public GetTimeSeriesCorrel200ResponseMetaIndicator timePeriod(@javax.annotation.Nonnull Long timePeriod) {
  ...
  /**
   * Return true if this GetTimeSeriesCorrel_200_response_meta_indicator object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetTimeSeriesCorrel200ResponseMetaIndicator getTimeSeriesCorrel200ResponseMetaIndicator = (GetTimeSeriesCorrel200ResponseMetaIndicator) o;
    return Objects.equals(this.name, getTimeSeriesCorrel200ResponseMetaIndicator.name) &&
        Objects.equals(this.seriesType1, getTimeSeriesCorrel200ResponseMetaIndicator.seriesType1) &&
        Objects.equals(this.seriesType2, getTimeSeriesCorrel200ResponseMetaIndicator.seriesType2) &&
        Objects.equals(this.timePeriod, getTimeSeriesCorrel200ResponseMetaIndicator.timePeriod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, seriesType1, seriesType2, timePeriod);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetTimeSeriesCorrel200ResponseMetaIndicator {\n");
