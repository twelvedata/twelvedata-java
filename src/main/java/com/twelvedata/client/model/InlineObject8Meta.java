...
import com.twelvedata.client.model.InlineObject8MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject8Meta.JSON_PROPERTY_SYMBOL,
  InlineObject8Meta.JSON_PROPERTY_INTERVAL,
  InlineObject8Meta.JSON_PROPERTY_CURRENCY,
  InlineObject8Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject8Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject8Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject8Meta.JSON_PROPERTY_TYPE,
  InlineObject8Meta.JSON_PROPERTY_INDICATOR
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class InlineObject8Meta {
  ...
  @javax.annotation.Nonnull
  private InlineObject8MetaIndicator indicator;

  public InlineObject8Meta() { 
  }

  public InlineObject8Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject8Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject8Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject8Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject8Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject8Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject8Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject8Meta indicator(@javax.annotation.Nonnull InlineObject8MetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InlineObject8MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull InlineObject8MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_8_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineObject8Meta inlineObject8Meta = (InlineObject8Meta) o;
    return Objects.equals(this.symbol, inlineObject8Meta.symbol) &&
        Objects.equals(this.interval, inlineObject8Meta.interval) &&
        Objects.equals(this.currency, inlineObject8Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject8Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject8Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject8Meta.micCode) &&
        Objects.equals(this.type, inlineObject8Meta.type) &&
        Objects.equals(this.indicator, inlineObject8Meta.indicator);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineObject8Meta {\n");
