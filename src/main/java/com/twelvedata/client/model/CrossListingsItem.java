 ...
 */
@JsonPropertyOrder({
  CrossListingsItem.JSON_PROPERTY_SYMBOL,
  CrossListingsItem.JSON_PROPERTY_NAME,
  CrossListingsItem.JSON_PROPERTY_EXCHANGE,
  CrossListingsItem.JSON_PROPERTY_MIC_CODE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class CrossListingsItem {
  ...
  public CrossListingsItem() { 
  }

  public CrossListingsItem symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public CrossListingsItem name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CrossListingsItem exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public CrossListingsItem micCode(@javax.annotation.Nonnull String micCode) {
  ...
  /**
   * Return true if this CrossListingsItem object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CrossListingsItem crossListingsItem = (CrossListingsItem) o;
    return Objects.equals(this.symbol, crossListingsItem.symbol) &&
        Objects.equals(this.name, crossListingsItem.name) &&
        Objects.equals(this.exchange, crossListingsItem.exchange) &&
        Objects.equals(this.micCode, crossListingsItem.micCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(symbol, name, exchange, micCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CrossListingsItem {\n");
