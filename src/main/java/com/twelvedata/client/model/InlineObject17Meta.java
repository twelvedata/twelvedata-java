...
import com.twelvedata.client.model.InlineObject17MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject17Meta.JSON_PROPERTY_SYMBOL,
  InlineObject17Meta.JSON_PROPERTY_INTERVAL,
  InlineObject17Meta.JSON_PROPERTY_CURRENCY,
  InlineObject17Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject17Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject17Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject17Meta.JSON_PROPERTY_TYPE,
  InlineObject17Meta.JSON_PROPERTY_INDICATOR
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class InlineObject17Meta {
  ...
  @javax.annotation.Nonnull
  private InlineObject17MetaIndicator indicator;

  public InlineObject17Meta() { 
  }

  public InlineObject17Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject17Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject17Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject17Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject17Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject17Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject17Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject17Meta indicator(@javax.annotation.Nonnull InlineObject17MetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InlineObject17MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull InlineObject17MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_17_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineObject17Meta inlineObject17Meta = (InlineObject17Meta) o;
    return Objects.equals(this.symbol, inlineObject17Meta.symbol) &&
        Objects.equals(this.interval, inlineObject17Meta.interval) &&
        Objects.equals(this.currency, inlineObject17Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject17Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject17Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject17Meta.micCode) &&
        Objects.equals(this.type, inlineObject17Meta.type) &&
        Objects.equals(this.indicator, inlineObject17Meta.indicator);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineObject17Meta {\n");
