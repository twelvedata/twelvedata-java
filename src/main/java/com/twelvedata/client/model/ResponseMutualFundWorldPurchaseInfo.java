 ...
 */
@JsonPropertyOrder({
  ResponseMutualFundWorldPurchaseInfo.JSON_PROPERTY_EXPENSES,
  ResponseMutualFundWorldPurchaseInfo.JSON_PROPERTY_MINIMUMS,
  ResponseMutualFundWorldPurchaseInfo.JSON_PROPERTY_PRICING,
  ResponseMutualFundWorldPurchaseInfo.JSON_PROPERTY_BROKERAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class ResponseMutualFundWorldPurchaseInfo {
  ...
  public ResponseMutualFundWorldPurchaseInfo() { 
  }

  public ResponseMutualFundWorldPurchaseInfo expenses(@javax.annotation.Nullable GetMutualFundsWorld200ResponseMutualFundPurchaseInfoExpenses expenses) {
  ...
  public ResponseMutualFundWorldPurchaseInfo minimums(@javax.annotation.Nullable GetMutualFundsWorld200ResponseMutualFundPurchaseInfoMinimums minimums) {
  ...
  public ResponseMutualFundWorldPurchaseInfo pricing(@javax.annotation.Nullable GetMutualFundsWorld200ResponseMutualFundPurchaseInfoPricing pricing) {
  ...
  public ResponseMutualFundWorldPurchaseInfo brokerages(@javax.annotation.Nullable List<String> brokerages) {
    this.brokerages = brokerages;
    return this;
  }

  public ResponseMutualFundWorldPurchaseInfo addBrokeragesItem(String brokeragesItem) {
  ...
  /**
   * Return true if this ResponseMutualFundWorldPurchaseInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ResponseMutualFundWorldPurchaseInfo responseMutualFundWorldPurchaseInfo = (ResponseMutualFundWorldPurchaseInfo) o;
    return Objects.equals(this.expenses, responseMutualFundWorldPurchaseInfo.expenses) &&
        Objects.equals(this.minimums, responseMutualFundWorldPurchaseInfo.minimums) &&
        Objects.equals(this.pricing, responseMutualFundWorldPurchaseInfo.pricing) &&
        Objects.equals(this.brokerages, responseMutualFundWorldPurchaseInfo.brokerages);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseMutualFundWorldPurchaseInfo {\n");
