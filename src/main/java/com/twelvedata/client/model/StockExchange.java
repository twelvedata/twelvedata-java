 ...
 */
@JsonPropertyOrder({
  StockExchange.JSON_PROPERTY_COUNTRY,
  StockExchange.JSON_PROPERTY_NAME
})
...
public class StockExchange {
  ...
  public StockExchange country(@javax.annotation.Nullable String country) {
  ...
  public StockExchange name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Return true if this StockExchange object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.country, stockExchange.country) &&
