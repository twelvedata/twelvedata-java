...
import com.twelvedata.client.model.GetTimeSeriesAd200ResponseMetaIndicator;
 ...
 */
@JsonPropertyOrder({
  GetTimeSeriesAd200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetTimeSeriesAd200ResponseMeta.JSON_PROPERTY_INTERVAL,
  GetTimeSeriesAd200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetTimeSeriesAd200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  GetTimeSeriesAd200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetTimeSeriesAd200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetTimeSeriesAd200ResponseMeta.JSON_PROPERTY_TYPE,
  GetTimeSeriesAd200ResponseMeta.JSON_PROPERTY_INDICATOR
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetTimeSeriesAd200ResponseMeta {
  ...
  @javax.annotation.Nonnull
  private GetTimeSeriesAd200ResponseMetaIndicator indicator;

  public GetTimeSeriesAd200ResponseMeta() { 
  }

  public GetTimeSeriesAd200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetTimeSeriesAd200ResponseMeta interval(@javax.annotation.Nonnull String interval) {
  ...
  public GetTimeSeriesAd200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetTimeSeriesAd200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public GetTimeSeriesAd200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetTimeSeriesAd200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetTimeSeriesAd200ResponseMeta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public GetTimeSeriesAd200ResponseMeta indicator(@javax.annotation.Nonnull GetTimeSeriesAd200ResponseMetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public GetTimeSeriesAd200ResponseMetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull GetTimeSeriesAd200ResponseMetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this GetTimeSeriesAd_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetTimeSeriesAd200ResponseMeta getTimeSeriesAd200ResponseMeta = (GetTimeSeriesAd200ResponseMeta) o;
    return Objects.equals(this.symbol, getTimeSeriesAd200ResponseMeta.symbol) &&
        Objects.equals(this.interval, getTimeSeriesAd200ResponseMeta.interval) &&
        Objects.equals(this.currency, getTimeSeriesAd200ResponseMeta.currency) &&
        Objects.equals(this.exchangeTimezone, getTimeSeriesAd200ResponseMeta.exchangeTimezone) &&
        Objects.equals(this.exchange, getTimeSeriesAd200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getTimeSeriesAd200ResponseMeta.micCode) &&
        Objects.equals(this.type, getTimeSeriesAd200ResponseMeta.type) &&
        Objects.equals(this.indicator, getTimeSeriesAd200ResponseMeta.indicator);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTimeSeriesAd200ResponseMeta {\n");
