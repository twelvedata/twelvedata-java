...
import com.twelvedata.client.model.InlineObject9MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject9Meta.JSON_PROPERTY_SYMBOL,
  InlineObject9Meta.JSON_PROPERTY_INTERVAL,
  InlineObject9Meta.JSON_PROPERTY_CURRENCY,
  InlineObject9Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject9Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject9Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject9Meta.JSON_PROPERTY_TYPE,
  InlineObject9Meta.JSON_PROPERTY_INDICATOR
})
...
public class InlineObject9Meta {
  ...
  @javax.annotation.Nonnull
  private InlineObject9MetaIndicator indicator;

  public InlineObject9Meta() { 
  }

  public InlineObject9Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject9Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject9Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject9Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject9Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject9Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject9Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject9Meta indicator(@javax.annotation.Nonnull InlineObject9MetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InlineObject9MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull InlineObject9MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_9_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.symbol, inlineObject9Meta.symbol) &&
        Objects.equals(this.interval, inlineObject9Meta.interval) &&
        Objects.equals(this.currency, inlineObject9Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject9Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject9Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject9Meta.micCode) &&
        Objects.equals(this.type, inlineObject9Meta.type) &&
        Objects.equals(this.indicator, inlineObject9Meta.indicator);
  }
