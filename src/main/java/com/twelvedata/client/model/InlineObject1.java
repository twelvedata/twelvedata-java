...
import com.twelvedata.client.model.Index;
 ...
 */
@JsonPropertyOrder({
  InlineObject1.JSON_PROPERTY_COUNT,
  InlineObject1.JSON_PROPERTY_DATA,
  InlineObject1.JSON_PROPERTY_STATUS
})
...
public class InlineObject1 {
  ...
  @javax.annotation.Nonnull
  private List<Index> data = new ArrayList<>();
  ...
  public InlineObject1 count(@javax.annotation.Nonnull Long count) {
    this.count = count;
    return this;
  }
  ...
  public InlineObject1 data(@javax.annotation.Nonnull List<Index> data) {
    this.data = data;
    return this;
  }

  public InlineObject1 addDataItem(Index dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<Index> data) {
    this.data = data;
  }


  public InlineObject1 status(@javax.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, inlineObject1.count) &&
