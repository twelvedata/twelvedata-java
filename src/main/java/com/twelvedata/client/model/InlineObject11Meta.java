...
import com.twelvedata.client.model.InlineObject11MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject11Meta.JSON_PROPERTY_SYMBOL,
  InlineObject11Meta.JSON_PROPERTY_INTERVAL,
  InlineObject11Meta.JSON_PROPERTY_CURRENCY,
  InlineObject11Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject11Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject11Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject11Meta.JSON_PROPERTY_TYPE,
  InlineObject11Meta.JSON_PROPERTY_INDICATOR
})
...
public class InlineObject11Meta {
  ...
  @javax.annotation.Nonnull
  private InlineObject11MetaIndicator indicator;

  public InlineObject11Meta() { 
  }

  public InlineObject11Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject11Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject11Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject11Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject11Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject11Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject11Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject11Meta indicator(@javax.annotation.Nonnull InlineObject11MetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InlineObject11MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull InlineObject11MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_11_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.symbol, inlineObject11Meta.symbol) &&
        Objects.equals(this.interval, inlineObject11Meta.interval) &&
        Objects.equals(this.currency, inlineObject11Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject11Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject11Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject11Meta.micCode) &&
        Objects.equals(this.type, inlineObject11Meta.type) &&
        Objects.equals(this.indicator, inlineObject11Meta.indicator);
  }
