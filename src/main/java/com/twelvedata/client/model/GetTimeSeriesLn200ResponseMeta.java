...
import com.twelvedata.client.model.GetTimeSeriesLn200ResponseMetaIndicator;
 ...
 */
@JsonPropertyOrder({
  GetTimeSeriesLn200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetTimeSeriesLn200ResponseMeta.JSON_PROPERTY_INTERVAL,
  GetTimeSeriesLn200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetTimeSeriesLn200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  GetTimeSeriesLn200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetTimeSeriesLn200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetTimeSeriesLn200ResponseMeta.JSON_PROPERTY_TYPE,
  GetTimeSeriesLn200ResponseMeta.JSON_PROPERTY_INDICATOR
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetTimeSeriesLn200ResponseMeta {
  ...
  @javax.annotation.Nonnull
  private GetTimeSeriesLn200ResponseMetaIndicator indicator;

  public GetTimeSeriesLn200ResponseMeta() { 
  }

  public GetTimeSeriesLn200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetTimeSeriesLn200ResponseMeta interval(@javax.annotation.Nonnull String interval) {
  ...
  public GetTimeSeriesLn200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetTimeSeriesLn200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public GetTimeSeriesLn200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetTimeSeriesLn200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetTimeSeriesLn200ResponseMeta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public GetTimeSeriesLn200ResponseMeta indicator(@javax.annotation.Nonnull GetTimeSeriesLn200ResponseMetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public GetTimeSeriesLn200ResponseMetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull GetTimeSeriesLn200ResponseMetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this GetTimeSeriesLn_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetTimeSeriesLn200ResponseMeta getTimeSeriesLn200ResponseMeta = (GetTimeSeriesLn200ResponseMeta) o;
    return Objects.equals(this.symbol, getTimeSeriesLn200ResponseMeta.symbol) &&
        Objects.equals(this.interval, getTimeSeriesLn200ResponseMeta.interval) &&
        Objects.equals(this.currency, getTimeSeriesLn200ResponseMeta.currency) &&
        Objects.equals(this.exchangeTimezone, getTimeSeriesLn200ResponseMeta.exchangeTimezone) &&
        Objects.equals(this.exchange, getTimeSeriesLn200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getTimeSeriesLn200ResponseMeta.micCode) &&
        Objects.equals(this.type, getTimeSeriesLn200ResponseMeta.type) &&
        Objects.equals(this.indicator, getTimeSeriesLn200ResponseMeta.indicator);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTimeSeriesLn200ResponseMeta {\n");
