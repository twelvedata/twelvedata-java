 ...
 */
@JsonPropertyOrder({
  GetETFsWorld200ResponseEtfComposition.JSON_PROPERTY_MAJOR_MARKET_SECTORS,
  GetETFsWorld200ResponseEtfComposition.JSON_PROPERTY_COUNTRY_ALLOCATION,
  GetETFsWorld200ResponseEtfComposition.JSON_PROPERTY_ASSET_ALLOCATION,
  GetETFsWorld200ResponseEtfComposition.JSON_PROPERTY_TOP_HOLDINGS,
  GetETFsWorld200ResponseEtfComposition.JSON_PROPERTY_BOND_BREAKDOWN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetETFsWorld200ResponseEtfComposition {
  ...
  public GetETFsWorld200ResponseEtfComposition() { 
  }

  public GetETFsWorld200ResponseEtfComposition majorMarketSectors(@javax.annotation.Nullable List<GetETFsWorld200ResponseEtfCompositionMajorMarketSectorsInner> majorMarketSectors) {
    this.majorMarketSectors = majorMarketSectors;
    return this;
  }

  public GetETFsWorld200ResponseEtfComposition addMajorMarketSectorsItem(GetETFsWorld200ResponseEtfCompositionMajorMarketSectorsInner majorMarketSectorsItem) {
  ...
  public GetETFsWorld200ResponseEtfComposition countryAllocation(@javax.annotation.Nullable List<GetETFsWorld200ResponseEtfCompositionCountryAllocationInner> countryAllocation) {
    this.countryAllocation = countryAllocation;
    return this;
  }

  public GetETFsWorld200ResponseEtfComposition addCountryAllocationItem(GetETFsWorld200ResponseEtfCompositionCountryAllocationInner countryAllocationItem) {
  ...
  public GetETFsWorld200ResponseEtfComposition assetAllocation(@javax.annotation.Nullable GetETFsWorld200ResponseEtfCompositionAssetAllocation assetAllocation) {
  ...
  public GetETFsWorld200ResponseEtfComposition topHoldings(@javax.annotation.Nullable List<GetETFsWorld200ResponseEtfCompositionTopHoldingsInner> topHoldings) {
    this.topHoldings = topHoldings;
    return this;
  }

  public GetETFsWorld200ResponseEtfComposition addTopHoldingsItem(GetETFsWorld200ResponseEtfCompositionTopHoldingsInner topHoldingsItem) {
  ...
  public GetETFsWorld200ResponseEtfComposition bondBreakdown(@javax.annotation.Nullable GetETFsWorld200ResponseEtfCompositionBondBreakdown bondBreakdown) {
  ...
  /**
   * Return true if this GetETFsWorld_200_response_etf_composition object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetETFsWorld200ResponseEtfComposition getETFsWorld200ResponseEtfComposition = (GetETFsWorld200ResponseEtfComposition) o;
    return Objects.equals(this.majorMarketSectors, getETFsWorld200ResponseEtfComposition.majorMarketSectors) &&
        Objects.equals(this.countryAllocation, getETFsWorld200ResponseEtfComposition.countryAllocation) &&
        Objects.equals(this.assetAllocation, getETFsWorld200ResponseEtfComposition.assetAllocation) &&
        Objects.equals(this.topHoldings, getETFsWorld200ResponseEtfComposition.topHoldings) &&
        Objects.equals(this.bondBreakdown, getETFsWorld200ResponseEtfComposition.bondBreakdown);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetETFsWorld200ResponseEtfComposition {\n");
