 ...
 */
@JsonPropertyOrder({
  GetDirectHolders200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetDirectHolders200ResponseMeta.JSON_PROPERTY_NAME,
  GetDirectHolders200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetDirectHolders200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetDirectHolders200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetDirectHolders200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetDirectHolders200ResponseMeta {
  ...
  public GetDirectHolders200ResponseMeta() { 
  }

  public GetDirectHolders200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetDirectHolders200ResponseMeta name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetDirectHolders200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetDirectHolders200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetDirectHolders200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetDirectHolders200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  /**
   * Return true if this GetDirectHolders_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetDirectHolders200ResponseMeta getDirectHolders200ResponseMeta = (GetDirectHolders200ResponseMeta) o;
    return Objects.equals(this.symbol, getDirectHolders200ResponseMeta.symbol) &&
        Objects.equals(this.name, getDirectHolders200ResponseMeta.name) &&
        Objects.equals(this.currency, getDirectHolders200ResponseMeta.currency) &&
        Objects.equals(this.exchange, getDirectHolders200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getDirectHolders200ResponseMeta.micCode) &&
        Objects.equals(this.exchangeTimezone, getDirectHolders200ResponseMeta.exchangeTimezone);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDirectHolders200ResponseMeta {\n");
