...
import com.twelvedata.client.model.InlineObject16MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject16Meta.JSON_PROPERTY_SYMBOL,
  InlineObject16Meta.JSON_PROPERTY_INTERVAL,
  InlineObject16Meta.JSON_PROPERTY_CURRENCY,
  InlineObject16Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject16Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject16Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject16Meta.JSON_PROPERTY_TYPE,
  InlineObject16Meta.JSON_PROPERTY_INDICATOR
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class InlineObject16Meta {
  ...
  @javax.annotation.Nonnull
  private InlineObject16MetaIndicator indicator;

  public InlineObject16Meta() { 
  }

  public InlineObject16Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject16Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject16Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject16Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject16Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject16Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject16Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject16Meta indicator(@javax.annotation.Nonnull InlineObject16MetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InlineObject16MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull InlineObject16MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_16_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineObject16Meta inlineObject16Meta = (InlineObject16Meta) o;
    return Objects.equals(this.symbol, inlineObject16Meta.symbol) &&
        Objects.equals(this.interval, inlineObject16Meta.interval) &&
        Objects.equals(this.currency, inlineObject16Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject16Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject16Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject16Meta.micCode) &&
        Objects.equals(this.type, inlineObject16Meta.type) &&
        Objects.equals(this.indicator, inlineObject16Meta.indicator);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineObject16Meta {\n");
