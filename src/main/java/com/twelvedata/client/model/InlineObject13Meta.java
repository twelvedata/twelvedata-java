...
import com.twelvedata.client.model.InlineObject13MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject13Meta.JSON_PROPERTY_SYMBOL,
  InlineObject13Meta.JSON_PROPERTY_INTERVAL,
  InlineObject13Meta.JSON_PROPERTY_CURRENCY,
  InlineObject13Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject13Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject13Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject13Meta.JSON_PROPERTY_TYPE,
  InlineObject13Meta.JSON_PROPERTY_INDICATOR
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class InlineObject13Meta {
  ...
  private InlineObject13MetaIndicator indicator;

  public InlineObject13Meta() { 
  }

  public InlineObject13Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject13Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject13Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject13Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject13Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject13Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject13Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject13Meta indicator(@javax.annotation.Nullable InlineObject13MetaIndicator indicator) {
  ...
  public InlineObject13MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIndicator(@javax.annotation.Nullable InlineObject13MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_13_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineObject13Meta inlineObject13Meta = (InlineObject13Meta) o;
    return Objects.equals(this.symbol, inlineObject13Meta.symbol) &&
        Objects.equals(this.interval, inlineObject13Meta.interval) &&
        Objects.equals(this.currency, inlineObject13Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject13Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject13Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject13Meta.micCode) &&
        Objects.equals(this.type, inlineObject13Meta.type) &&
        Objects.equals(this.indicator, inlineObject13Meta.indicator);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineObject13Meta {\n");
