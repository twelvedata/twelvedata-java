 ...
 */
@JsonPropertyOrder({
  GetEarningsEstimate200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetEarningsEstimate200ResponseMeta.JSON_PROPERTY_NAME,
  GetEarningsEstimate200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetEarningsEstimate200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  GetEarningsEstimate200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetEarningsEstimate200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetEarningsEstimate200ResponseMeta.JSON_PROPERTY_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetEarningsEstimate200ResponseMeta {
  ...
  public GetEarningsEstimate200ResponseMeta() { 
  }

  public GetEarningsEstimate200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetEarningsEstimate200ResponseMeta name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetEarningsEstimate200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetEarningsEstimate200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public GetEarningsEstimate200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetEarningsEstimate200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetEarningsEstimate200ResponseMeta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  /**
   * Return true if this GetEarningsEstimate_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetEarningsEstimate200ResponseMeta getEarningsEstimate200ResponseMeta = (GetEarningsEstimate200ResponseMeta) o;
    return Objects.equals(this.symbol, getEarningsEstimate200ResponseMeta.symbol) &&
        Objects.equals(this.name, getEarningsEstimate200ResponseMeta.name) &&
        Objects.equals(this.currency, getEarningsEstimate200ResponseMeta.currency) &&
        Objects.equals(this.exchangeTimezone, getEarningsEstimate200ResponseMeta.exchangeTimezone) &&
        Objects.equals(this.exchange, getEarningsEstimate200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getEarningsEstimate200ResponseMeta.micCode) &&
        Objects.equals(this.type, getEarningsEstimate200ResponseMeta.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEarningsEstimate200ResponseMeta {\n");
