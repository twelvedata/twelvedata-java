 ...
 */
@JsonPropertyOrder({
  GetInsiderTransactions200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetInsiderTransactions200ResponseMeta.JSON_PROPERTY_NAME,
  GetInsiderTransactions200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetInsiderTransactions200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetInsiderTransactions200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetInsiderTransactions200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetInsiderTransactions200ResponseMeta {
  ...
  public GetInsiderTransactions200ResponseMeta() { 
  }

  public GetInsiderTransactions200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetInsiderTransactions200ResponseMeta name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetInsiderTransactions200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetInsiderTransactions200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetInsiderTransactions200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetInsiderTransactions200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  /**
   * Return true if this GetInsiderTransactions_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetInsiderTransactions200ResponseMeta getInsiderTransactions200ResponseMeta = (GetInsiderTransactions200ResponseMeta) o;
    return Objects.equals(this.symbol, getInsiderTransactions200ResponseMeta.symbol) &&
        Objects.equals(this.name, getInsiderTransactions200ResponseMeta.name) &&
        Objects.equals(this.currency, getInsiderTransactions200ResponseMeta.currency) &&
        Objects.equals(this.exchange, getInsiderTransactions200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getInsiderTransactions200ResponseMeta.micCode) &&
        Objects.equals(this.exchangeTimezone, getInsiderTransactions200ResponseMeta.exchangeTimezone);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetInsiderTransactions200ResponseMeta {\n");
