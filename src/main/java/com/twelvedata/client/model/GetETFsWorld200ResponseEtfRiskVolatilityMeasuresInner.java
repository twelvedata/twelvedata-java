 ...
 */
@JsonPropertyOrder({
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_PERIOD,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_ALPHA,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_ALPHA_CATEGORY,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_BETA,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_BETA_CATEGORY,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_MEAN_ANNUAL_RETURN,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_MEAN_ANNUAL_RETURN_CATEGORY,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_R_SQUARED,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_R_SQUARED_CATEGORY,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_STD,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_STD_CATEGORY,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_SHARPE_RATIO,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_SHARPE_RATIO_CATEGORY,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_TREYNOR_RATIO,
  GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.JSON_PROPERTY_TREYNOR_RATIO_CATEGORY
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner() { 
  }

  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner period(@javax.annotation.Nullable String period) {
    this.period = period;
    return this;
  }
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner alpha(@javax.annotation.Nullable Double alpha) {
    this.alpha = alpha;
    return this;
  }
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner alphaCategory(@javax.annotation.Nullable Double alphaCategory) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner beta(@javax.annotation.Nullable Double beta) {
    this.beta = beta;
    return this;
  }
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner betaCategory(@javax.annotation.Nullable Double betaCategory) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner meanAnnualReturn(@javax.annotation.Nullable Double meanAnnualReturn) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner meanAnnualReturnCategory(@javax.annotation.Nullable Double meanAnnualReturnCategory) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner rSquared(@javax.annotation.Nullable Double rSquared) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner rSquaredCategory(@javax.annotation.Nullable Double rSquaredCategory) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner std(@javax.annotation.Nullable Double std) {
    this.std = std;
    return this;
  }
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner stdCategory(@javax.annotation.Nullable Double stdCategory) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner sharpeRatio(@javax.annotation.Nullable Double sharpeRatio) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner sharpeRatioCategory(@javax.annotation.Nullable Double sharpeRatioCategory) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner treynorRatio(@javax.annotation.Nullable Double treynorRatio) {
  ...
  public GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner treynorRatioCategory(@javax.annotation.Nullable Double treynorRatioCategory) {
  ...
  /**
   * Return true if this GetETFsWorld_200_response_etf_risk_volatility_measures_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner = (GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner) o;
    return Objects.equals(this.period, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.period) &&
        Objects.equals(this.alpha, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.alpha) &&
        Objects.equals(this.alphaCategory, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.alphaCategory) &&
        Objects.equals(this.beta, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.beta) &&
        Objects.equals(this.betaCategory, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.betaCategory) &&
        Objects.equals(this.meanAnnualReturn, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.meanAnnualReturn) &&
        Objects.equals(this.meanAnnualReturnCategory, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.meanAnnualReturnCategory) &&
        Objects.equals(this.rSquared, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.rSquared) &&
        Objects.equals(this.rSquaredCategory, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.rSquaredCategory) &&
        Objects.equals(this.std, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.std) &&
        Objects.equals(this.stdCategory, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.stdCategory) &&
        Objects.equals(this.sharpeRatio, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.sharpeRatio) &&
        Objects.equals(this.sharpeRatioCategory, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.sharpeRatioCategory) &&
        Objects.equals(this.treynorRatio, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.treynorRatio) &&
        Objects.equals(this.treynorRatioCategory, getETFsWorld200ResponseEtfRiskVolatilityMeasuresInner.treynorRatioCategory);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner {\n");
