 ...
 */
@JsonPropertyOrder({
  GetFundHolders200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetFundHolders200ResponseMeta.JSON_PROPERTY_NAME,
  GetFundHolders200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetFundHolders200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetFundHolders200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetFundHolders200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetFundHolders200ResponseMeta {
  ...
  public GetFundHolders200ResponseMeta() { 
  }

  public GetFundHolders200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetFundHolders200ResponseMeta name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetFundHolders200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetFundHolders200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetFundHolders200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetFundHolders200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  /**
   * Return true if this GetFundHolders_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetFundHolders200ResponseMeta getFundHolders200ResponseMeta = (GetFundHolders200ResponseMeta) o;
    return Objects.equals(this.symbol, getFundHolders200ResponseMeta.symbol) &&
        Objects.equals(this.name, getFundHolders200ResponseMeta.name) &&
        Objects.equals(this.currency, getFundHolders200ResponseMeta.currency) &&
        Objects.equals(this.exchange, getFundHolders200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getFundHolders200ResponseMeta.micCode) &&
        Objects.equals(this.exchangeTimezone, getFundHolders200ResponseMeta.exchangeTimezone);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFundHolders200ResponseMeta {\n");
