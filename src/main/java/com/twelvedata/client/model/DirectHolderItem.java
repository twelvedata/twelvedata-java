 ...
 */
@JsonPropertyOrder({
  DirectHolderItem.JSON_PROPERTY_ENTITY_NAME,
  DirectHolderItem.JSON_PROPERTY_DATE_REPORTED,
  DirectHolderItem.JSON_PROPERTY_SHARES,
  DirectHolderItem.JSON_PROPERTY_VALUE,
  DirectHolderItem.JSON_PROPERTY_PERCENT_HELD
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class DirectHolderItem {
  ...
  public DirectHolderItem() { 
  }

  public DirectHolderItem entityName(@javax.annotation.Nonnull String entityName) {
  ...
  public DirectHolderItem dateReported(@javax.annotation.Nullable String dateReported) {
  ...
  public DirectHolderItem shares(@javax.annotation.Nullable Long shares) {
    this.shares = shares;
    return this;
  }
  ...
  public DirectHolderItem value(@javax.annotation.Nullable Long value) {
    this.value = value;
    return this;
  }
  ...
  public DirectHolderItem percentHeld(@javax.annotation.Nullable Double percentHeld) {
  ...
  /**
   * Return true if this DirectHolderItem object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DirectHolderItem directHolderItem = (DirectHolderItem) o;
    return Objects.equals(this.entityName, directHolderItem.entityName) &&
        Objects.equals(this.dateReported, directHolderItem.dateReported) &&
        Objects.equals(this.shares, directHolderItem.shares) &&
        Objects.equals(this.value, directHolderItem.value) &&
        Objects.equals(this.percentHeld, directHolderItem.percentHeld);
  }
  ...
  public String toString() {
    ...
    sb.append("class DirectHolderItem {\n");
