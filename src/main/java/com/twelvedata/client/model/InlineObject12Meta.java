...
import com.twelvedata.client.model.InlineObject12MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject12Meta.JSON_PROPERTY_SYMBOL,
  InlineObject12Meta.JSON_PROPERTY_INTERVAL,
  InlineObject12Meta.JSON_PROPERTY_CURRENCY,
  InlineObject12Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject12Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject12Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject12Meta.JSON_PROPERTY_TYPE,
  InlineObject12Meta.JSON_PROPERTY_INDICATOR
})
...
public class InlineObject12Meta {
  ...
  @javax.annotation.Nonnull
  private InlineObject12MetaIndicator indicator;

  public InlineObject12Meta() { 
  }

  public InlineObject12Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject12Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject12Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject12Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject12Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject12Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject12Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject12Meta indicator(@javax.annotation.Nonnull InlineObject12MetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InlineObject12MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull InlineObject12MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_12_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.symbol, inlineObject12Meta.symbol) &&
        Objects.equals(this.interval, inlineObject12Meta.interval) &&
        Objects.equals(this.currency, inlineObject12Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject12Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject12Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject12Meta.micCode) &&
        Objects.equals(this.type, inlineObject12Meta.type) &&
        Objects.equals(this.indicator, inlineObject12Meta.indicator);
  }
