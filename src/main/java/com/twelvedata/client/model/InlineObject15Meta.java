...
import com.twelvedata.client.model.InlineObject15MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject15Meta.JSON_PROPERTY_SYMBOL,
  InlineObject15Meta.JSON_PROPERTY_INTERVAL,
  InlineObject15Meta.JSON_PROPERTY_CURRENCY,
  InlineObject15Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject15Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject15Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject15Meta.JSON_PROPERTY_TYPE,
  InlineObject15Meta.JSON_PROPERTY_INDICATOR
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class InlineObject15Meta {
  ...
  @javax.annotation.Nonnull
  private InlineObject15MetaIndicator indicator;

  public InlineObject15Meta() { 
  }

  public InlineObject15Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject15Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject15Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject15Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject15Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject15Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject15Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject15Meta indicator(@javax.annotation.Nonnull InlineObject15MetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InlineObject15MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull InlineObject15MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_15_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InlineObject15Meta inlineObject15Meta = (InlineObject15Meta) o;
    return Objects.equals(this.symbol, inlineObject15Meta.symbol) &&
        Objects.equals(this.interval, inlineObject15Meta.interval) &&
        Objects.equals(this.currency, inlineObject15Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject15Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject15Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject15Meta.micCode) &&
        Objects.equals(this.type, inlineObject15Meta.type) &&
        Objects.equals(this.indicator, inlineObject15Meta.indicator);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineObject15Meta {\n");
