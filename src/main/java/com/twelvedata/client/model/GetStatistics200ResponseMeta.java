 ...
 */
@JsonPropertyOrder({
  GetStatistics200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetStatistics200ResponseMeta.JSON_PROPERTY_NAME,
  GetStatistics200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetStatistics200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetStatistics200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetStatistics200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetStatistics200ResponseMeta {
  ...
  public GetStatistics200ResponseMeta() { 
  }

  public GetStatistics200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetStatistics200ResponseMeta name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetStatistics200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetStatistics200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetStatistics200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetStatistics200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  /**
   * Return true if this GetStatistics_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetStatistics200ResponseMeta getStatistics200ResponseMeta = (GetStatistics200ResponseMeta) o;
    return Objects.equals(this.symbol, getStatistics200ResponseMeta.symbol) &&
        Objects.equals(this.name, getStatistics200ResponseMeta.name) &&
        Objects.equals(this.currency, getStatistics200ResponseMeta.currency) &&
        Objects.equals(this.exchange, getStatistics200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getStatistics200ResponseMeta.micCode) &&
        Objects.equals(this.exchangeTimezone, getStatistics200ResponseMeta.exchangeTimezone);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetStatistics200ResponseMeta {\n");
