 ...
 */
@JsonPropertyOrder({
  GetKeyExecutives200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetKeyExecutives200ResponseMeta.JSON_PROPERTY_NAME,
  GetKeyExecutives200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetKeyExecutives200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetKeyExecutives200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetKeyExecutives200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetKeyExecutives200ResponseMeta {
  ...
  public GetKeyExecutives200ResponseMeta() { 
  }

  public GetKeyExecutives200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetKeyExecutives200ResponseMeta name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetKeyExecutives200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetKeyExecutives200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetKeyExecutives200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetKeyExecutives200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  /**
   * Return true if this GetKeyExecutives_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetKeyExecutives200ResponseMeta getKeyExecutives200ResponseMeta = (GetKeyExecutives200ResponseMeta) o;
    return Objects.equals(this.symbol, getKeyExecutives200ResponseMeta.symbol) &&
        Objects.equals(this.name, getKeyExecutives200ResponseMeta.name) &&
        Objects.equals(this.currency, getKeyExecutives200ResponseMeta.currency) &&
        Objects.equals(this.exchange, getKeyExecutives200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getKeyExecutives200ResponseMeta.micCode) &&
        Objects.equals(this.exchangeTimezone, getKeyExecutives200ResponseMeta.exchangeTimezone);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetKeyExecutives200ResponseMeta {\n");
