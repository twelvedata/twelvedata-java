...
import com.twelvedata.client.model.InlineObject10MetaIndicator;
 ...
 */
@JsonPropertyOrder({
  InlineObject10Meta.JSON_PROPERTY_SYMBOL,
  InlineObject10Meta.JSON_PROPERTY_INTERVAL,
  InlineObject10Meta.JSON_PROPERTY_CURRENCY,
  InlineObject10Meta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  InlineObject10Meta.JSON_PROPERTY_EXCHANGE,
  InlineObject10Meta.JSON_PROPERTY_MIC_CODE,
  InlineObject10Meta.JSON_PROPERTY_TYPE,
  InlineObject10Meta.JSON_PROPERTY_INDICATOR
})
...
public class InlineObject10Meta {
  ...
  @javax.annotation.Nonnull
  private InlineObject10MetaIndicator indicator;

  public InlineObject10Meta() { 
  }

  public InlineObject10Meta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public InlineObject10Meta interval(@javax.annotation.Nonnull String interval) {
  ...
  public InlineObject10Meta currency(@javax.annotation.Nonnull String currency) {
  ...
  public InlineObject10Meta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public InlineObject10Meta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public InlineObject10Meta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public InlineObject10Meta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public InlineObject10Meta indicator(@javax.annotation.Nonnull InlineObject10MetaIndicator indicator) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InlineObject10MetaIndicator getIndicator() {
    return indicator;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIndicator(@javax.annotation.Nonnull InlineObject10MetaIndicator indicator) {
    this.indicator = indicator;
  }


  /**
   * Return true if this inline_object_10_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.symbol, inlineObject10Meta.symbol) &&
        Objects.equals(this.interval, inlineObject10Meta.interval) &&
        Objects.equals(this.currency, inlineObject10Meta.currency) &&
        Objects.equals(this.exchangeTimezone, inlineObject10Meta.exchangeTimezone) &&
        Objects.equals(this.exchange, inlineObject10Meta.exchange) &&
        Objects.equals(this.micCode, inlineObject10Meta.micCode) &&
        Objects.equals(this.type, inlineObject10Meta.type) &&
        Objects.equals(this.indicator, inlineObject10Meta.indicator);
  }
