 ...
 */
@JsonPropertyOrder({
  GetRecommendations200ResponseMeta.JSON_PROPERTY_SYMBOL,
  GetRecommendations200ResponseMeta.JSON_PROPERTY_NAME,
  GetRecommendations200ResponseMeta.JSON_PROPERTY_CURRENCY,
  GetRecommendations200ResponseMeta.JSON_PROPERTY_EXCHANGE_TIMEZONE,
  GetRecommendations200ResponseMeta.JSON_PROPERTY_EXCHANGE,
  GetRecommendations200ResponseMeta.JSON_PROPERTY_MIC_CODE,
  GetRecommendations200ResponseMeta.JSON_PROPERTY_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.19.0")
public class GetRecommendations200ResponseMeta {
  ...
  public GetRecommendations200ResponseMeta() { 
  }

  public GetRecommendations200ResponseMeta symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public GetRecommendations200ResponseMeta name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GetRecommendations200ResponseMeta currency(@javax.annotation.Nonnull String currency) {
  ...
  public GetRecommendations200ResponseMeta exchangeTimezone(@javax.annotation.Nonnull String exchangeTimezone) {
  ...
  public GetRecommendations200ResponseMeta exchange(@javax.annotation.Nonnull String exchange) {
  ...
  public GetRecommendations200ResponseMeta micCode(@javax.annotation.Nonnull String micCode) {
  ...
  public GetRecommendations200ResponseMeta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  /**
   * Return true if this GetRecommendations_200_response_meta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetRecommendations200ResponseMeta getRecommendations200ResponseMeta = (GetRecommendations200ResponseMeta) o;
    return Objects.equals(this.symbol, getRecommendations200ResponseMeta.symbol) &&
        Objects.equals(this.name, getRecommendations200ResponseMeta.name) &&
        Objects.equals(this.currency, getRecommendations200ResponseMeta.currency) &&
        Objects.equals(this.exchangeTimezone, getRecommendations200ResponseMeta.exchangeTimezone) &&
        Objects.equals(this.exchange, getRecommendations200ResponseMeta.exchange) &&
        Objects.equals(this.micCode, getRecommendations200ResponseMeta.micCode) &&
        Objects.equals(this.type, getRecommendations200ResponseMeta.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRecommendations200ResponseMeta {\n");
