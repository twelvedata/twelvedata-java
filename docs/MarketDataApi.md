...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            GetEod200Response result = apiInstance.getEod(symbol, figi, isin, cusip, exchange, micCode, country, type, date, prepost, dp);
...
> ApiResponse<GetEod200Response> getEod getEodWithHttpInfo(symbol, figi, isin, cusip, exchange, micCode, country, type, date, prepost, dp)
...
public class Example {
    public static void main(String[] args) {
        ...
        Long dp = 5L; // Long | Specifies the number of decimal places for floating values Should be in range [0,11] inclusive
        try {
            ApiResponse<GetEod200Response> response = apiInstance.getEodWithHttpInfo(symbol, figi, isin, cusip, exchange, micCode, country, type, date, prepost, dp);
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            MarketMoversResponseBody result = apiInstance.getMarketMovers(market, direction, outputsize, country, priceGreaterThan, dp);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApiResponse<MarketMoversResponseBody> getMarketMovers getMarketMoversWithHttpInfo(market, direction, outputsize, country, priceGreaterThan, dp)
...
public class Example {
    public static void main(String[] args) {
        ...
        String dp = "5"; // String | Specifies the number of decimal places for floating values. Should be in range [0,11] inclusive
        try {
            ApiResponse<MarketMoversResponseBody> response = apiInstance.getMarketMoversWithHttpInfo(market, direction, outputsize, country, priceGreaterThan, dp);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        Long dp = 5L; // Long | Specifies the number of decimal places for floating values. Should be in range [0,11] inclusive
        try {
            GetPrice200Response result = apiInstance.getPrice(symbol, figi, isin, cusip, exchange, micCode, country, type, format, delimiter, prepost, dp);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApiResponse<GetPrice200Response> getPrice getPriceWithHttpInfo(symbol, figi, isin, cusip, exchange, micCode, country, type, format, delimiter, prepost, dp)
...
public class Example {
    public static void main(String[] args) {
        ...
        Long dp = 5L; // Long | Specifies the number of decimal places for floating values. Should be in range [0,11] inclusive
        try {
            ApiResponse<GetPrice200Response> response = apiInstance.getPriceWithHttpInfo(symbol, figi, isin, cusip, exchange, micCode, country, type, format, delimiter, prepost, dp);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            GetQuote200Response result = apiInstance.getQuote(symbol, figi, isin, cusip, interval, exchange, micCode, country, volumeTimePeriod, type, format, delimiter, prepost, eod, rollingPeriod, dp, timezone);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApiResponse<GetQuote200Response> getQuote getQuoteWithHttpInfo(symbol, figi, isin, cusip, interval, exchange, micCode, country, volumeTimePeriod, type, format, delimiter, prepost, eod, rollingPeriod, dp, timezone)
...
public class Example {
    public static void main(String[] args) {
        ...
        String timezone = "Exchange"; // String | Timezone at which output datetime will be displayed. Supports: <ul> <li>1. <code>Exchange</code> for local exchange time</li> <li>2. <code>UTC</code> for datetime at universal UTC standard</li> <li>3. Timezone name according to the IANA Time Zone Database. E.g. <code>America/New_York</code>, <code>Asia/Singapore</code>. Full list of timezones can be found <a href=\"https://en.wikipedia.org/wiki/List_of_tz_database_time_zones\" target=\"blank\">here</a>.</li> </ul> <p>Interval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.</p> <i>Take note that the IANA Timezone name is case-sensitive</i>
        try {
            ApiResponse<GetQuote200Response> response = apiInstance.getQuoteWithHttpInfo(symbol, figi, isin, cusip, interval, exchange, micCode, country, volumeTimePeriod, type, format, delimiter, prepost, eod, rollingPeriod, dp, timezone);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            GetTimeSeries200Response result = apiInstance.getTimeSeries(interval, symbol, isin, figi, cusip, outputsize, exchange, micCode, country, type, timezone, startDate, endDate, date, order, prepost, format, delimiter, dp, previousClose, adjust);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApiResponse<GetTimeSeries200Response> getTimeSeries getTimeSeriesWithHttpInfo(interval, symbol, isin, figi, cusip, outputsize, exchange, micCode, country, type, timezone, startDate, endDate, date, order, prepost, format, delimiter, dp, previousClose, adjust)
...
public class Example {
    public static void main(String[] args) {
        ...
        AdjustEnum adjust = AdjustEnum.fromValue("all"); // AdjustEnum | Adjusting mode for prices
        try {
            ApiResponse<GetTimeSeries200Response> response = apiInstance.getTimeSeriesWithHttpInfo(interval, symbol, isin, figi, cusip, outputsize, exchange, micCode, country, type, timezone, startDate, endDate, date, order, prepost, format, delimiter, dp, previousClose, adjust);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            GetTimeSeriesCross200Response result = apiInstance.getTimeSeriesCross(base, quote, interval, baseType, baseExchange, baseMicCode, quoteType, quoteExchange, quoteMicCode, outputsize, format, delimiter, prepost, startDate, endDate, adjust, dp, timezone);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApiResponse<GetTimeSeriesCross200Response> getTimeSeriesCross getTimeSeriesCrossWithHttpInfo(base, quote, interval, baseType, baseExchange, baseMicCode, quoteType, quoteExchange, quoteMicCode, outputsize, format, delimiter, prepost, startDate, endDate, adjust, dp, timezone)
...
public class Example {
    public static void main(String[] args) {
        ...
        String timezone = "UTC"; // String | Timezone at which output datetime will be displayed. Supports: <ul> <li>1. <code>Exchange</code> for local exchange time</li> <li>2. <code>UTC</code> for datetime at universal UTC standard</li> <li>3. Timezone name according to the IANA Time Zone Database. E.g. <code>America/New_York</code>, <code>Asia/Singapore</code>. Full list of timezones can be found <a href=\"https://en.wikipedia.org/wiki/List_of_tz_database_time_zones\" target=\"blank\">here</a>.</li> </ul> <i>Take note that the IANA Timezone name is case-sensitive</i>
        try {
            ApiResponse<GetTimeSeriesCross200Response> response = apiInstance.getTimeSeriesCrossWithHttpInfo(base, quote, interval, baseType, baseExchange, baseMicCode, quoteType, quoteExchange, quoteMicCode, outputsize, format, delimiter, prepost, startDate, endDate, adjust, dp, timezone);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
